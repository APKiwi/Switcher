...
class AppDelegate: NSObject, NSApplicationDelegate, HotkeyManagerDelegate, AppSwitcherPanelDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        // Settings: register in-process fallbacks before any read. Must precede
        // startObserving, whose MRU seed queries the window list and would
        // otherwise read hideMinimizedOnlyApps as an unregistered false, seeding
        // from windows the switcher will never show.
